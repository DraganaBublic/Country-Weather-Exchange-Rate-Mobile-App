...
var HomePage = /** @class */ (function () {
    function HomePage(mhs, router, cs, cdr) {
        this.mhs = mhs;
        this.router = router;
        this.cs = cs;
        this.cdr = cdr;
    ...
    HomePage.prototype.getCountryData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mhs.getCountries(this.options)];
                    case 1:
                        result = _a.sent();
                        this.countryData = result.data;
                        this.filteredCountryData = __spreadArrays(this.countryData);
                        return [2 /*return*/];
                }
            });
        });
    ...
    HomePage.prototype.openCountryDetails = function (country) {
    ...
    HomePage.prototype.onSearchChange = function (event) {
        var searchTerm = event.detail.value.toLowerCase();
        this.filteredCountryData = this.countryData.filter(function (country) { return country.name.official.toLowerCase().includes(searchTerm); });
    };
    HomePage = __decorate([
        core_1.Component({
            selector: 'app-home',
